...
func init() {
	registry.Add("citroen", withContext(NewCitroenFromConfig))
	registry.Add("ds", withContext(NewDSFromConfig))
	registry.Add("opel", withContext(NewOpelFromConfig))
	registry.Add("peugeot", withContext(NewPeugeotFromConfig))
}
